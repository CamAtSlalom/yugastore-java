...
1. **Load Context**:
   ...
   - **Load ALL project context**: Read `CLAUDE.md` and entire `ai-docs/` directory including:
     - All ai-docs files (regardless of mode settings)
...
- **Project Context Missing**: Warn user that CLAUDE.md or ai-docs/ is missing and may affect requirement quality
