...
- Verify `.sdd/specs/$1/` exists
- Verify `.sdd/specs/$1/requirements.md` exists
...
- CLAUDE.md
- ai-docs/*.md
- .sdd-settings/rules/design-*.md
- .sdd-settings/templates/specs/design.md
- .sdd-settings/templates/specs/research.md
